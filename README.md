...
> Small, composable skills for the [vpeetla-ai](https://github.com/vpeetla-ai) stack. They encode the judgments we keep re-learning — gateway before side effects, access before ranking, orchestration ≠ governance — so agents don't invent a new architecture every PR.

**Portfolio:** [Case study](https://github.com/vpeetla-ai/ai-architecture-portfolio/blob/main/case-studies/vpeetla-ai-skills.md) · [Repo index](https://github.com/vpeetla-ai/ai-architecture-portfolio/blob/main/docs/REPO_INDEX.md) · [Human voice bar](docs/HUMAN_VOICE_PASS.md)
>
